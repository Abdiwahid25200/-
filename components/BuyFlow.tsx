    ...
    <div className="flex flex-col gap-5">
      ...
      <section ref={packsRef}>
        ...
        {/* صفٌّ واحد: يُقرأ كقائمة أسعار، لا شبكةٌ تُقارَن فيها أربعٌ في آن.
            🖥️ **ويبقى عموداً على اللابتوب** (قرارها محفوظ) — لكن عرضُه
            يُحبس: قسيمةُ سعرٍ ممتدّةٌ على ٩٦٠px تُبعد السعر عن اسمه
            بعرض الشاشة، فتُقرأ بحركةِ عينٍ لا بلمحة. */}
        <div className="flex flex-col gap-2.5 lg:max-w-[620px]">
          {packs.map((p) => (
