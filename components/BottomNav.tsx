...
export default function BottomNav() {
  ...
  return (
    ...
    /* 🖥️ **ويختفي على اللابتوب وحده** (٠٧-٠٨): شريطٌ ملتصقٌ بقاع شاشةٍ
       عريضة يبدو خطأً لا تصميماً، ويدُها على الفأرة لا على الإبهام.
       والأقسام تصعد إلى الهيدر (`TopNav`) عند الحدّ نفسه.

       🚨 **والحدّ `xl` (١٢٨٠) لا `lg` (١٠٢٤)** — بلاغها (٠٧-٠٨): «أعد
          القائمة السفلية إلى مكانها في الآيباد». **آيبادها العرضيّ
          عرضُه ١٠٢٤ بالضبط**، فوقع داخل حدّ اللابتوب فاختفى شريطُه.
          وهي **العلّة نفسها التي أسقطت محاولة ٠٤-٠٨** في لوحة الإدارة
          («الآن حتى الآيباد ما استوت») — والآيباد جهازُ لمسٍ إبهامُه
          على الشاشة، فشريطُه أسفل.

       📱 **وفي التطبيق يبقى مهما اتّسعت الشاشة.** التطبيقاتُ لها
          أشرطةٌ سفلية على الآيباد كما على الجوّال، وهي عُرفُ المنصّة
          لا ضيقُ الشاشة. */
    <div
