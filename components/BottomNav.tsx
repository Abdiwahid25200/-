...
export default function BottomNav() {
  ...
  return (
    ...
    /* 🖥️ **ويختفي على اللابتوب** (٠٧-٠٨): شريطٌ ملتصقٌ بقاع شاشةٍ
       ...
       📱 **إلّا في التطبيق — فيبقى مهما اتّسعت الشاشة.** التطبيقاتُ
          لها أشرطةٌ سفلية على الآيباد كما على الجوّال، وهي عُرفُ
          المنصّة لا ضيقُ الشاشة. وتطبيقٌ يضع تنقّلَه في الأعلى على
          الآيباد يبدو صفحةَ وِبٍ فُتحت داخله. */
    <div
      className={`fx-w fixed bottom-0 z-40 bg-surface pb-[env(safe-area-inset-bottom)] ${
        isApp ? "" : "lg:hidden"
      }`}
    >
