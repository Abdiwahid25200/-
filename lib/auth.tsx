 ...
 */
/**
 * 🛑 **ولا يُبدَّل هذا الشرط بلا اختبارٍ على جهازها** (ملاحظة ٠٧-٠٨):
 *    جُرّب دفعُ التطبيق المثبَّت إلى التحويل ظنّاً أنه سببُ «ينسانا في
 *    كل فتحة» — وهو **نقضٌ لإصلاح ٠٣-٠٨ أعلاه** الذي جاء من بلاغها
 *    «لا يشتغل في التطبيق». و«ينسى» أهونُ من «لا يعمل»، فأُعيد كما كان.
 */
