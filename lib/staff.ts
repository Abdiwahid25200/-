...
export type StaffDoc = {
  ...
  active?: boolean;
  /**
   * رقم واتساب المساعد بمفتاح دولته — أرقامٌ فقط بلا `+` ولا مسافات.
   *
   * ⚠️ **لازمٌ عند الإنشاء لا زينة**: هو الرقم الذي يُرسَل إليه رمز
   *    التحقّق عند تفعيله، وهو طريقُك إليه حين يتعثّر أو يغيب.
   *    ولو تُرك فارغاً لَما عرفتِ صاحب الاسم بعد شهر.
   */
  phone?: string;
};
