        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              /* 🔒 `<` تُبدَّل بـ`<`: نصوص البطاقة تُقرأ من الإعدادات،
                 ويكفي أن يتسلّل `</script>` في اسم المتجر ليُغلق الوسم
                 ويصير ما بعده كوداً يعمل في كل صفحة. `JSON.stringify`
                 لا يهرّب هذا الحرف وحده — وهو سطرٌ واحد يمنع البابَ
                 كلّه، سواءٌ جاء الخطأ من يدها أو من حسابٍ مسروق. */
            }).replace(/</g, "\\u003c"),
          }}
        />
      </head>
