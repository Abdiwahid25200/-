...
export const config = {
  ...
  // و`app-manifest` مستثنى: بطاقة التطبيق تُقدَّم بلغتها من مسارها هو،
  // ولو مرّت هنا لأُضيفت لها بادئة لغةٍ فعادت صفحةَ HTML بدل JSON —
  // فيصير الموقع غير قابلٍ للتثبيت أصلاً.
  matcher: "/((?!api|admin|app-manifest|_next|_vercel|__|.*\\..*).*)",
};
